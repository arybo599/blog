...
class Category(models.Model):
    ...
    slug = models.SlugField(max_length=200, unique=True, allow_unicode=True, verbose_name="آدرس دسته بندی")
...
class Article(models.Model):
    ...
    thumbnail = models.ImageField(upload_to="images", verbose_name="نصویر مقاله")
